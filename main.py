...
def index_get():
    # rq_code_url = url_for('static', filename=Config.QR_CODE_DEFAULT_FILE_NAME)
    form = '<h1>Welcome!</h1><br><h3>Make your own QR Code.</h3> \
                <form method="POST" action="/"> \
                <label for="qrurl">Enter URL for generating its QR code:</label><br> \
